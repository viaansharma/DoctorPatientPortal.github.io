...
{  
	...
	$_SESSION['email']=$UserID;
  	...
  	echo "<script>alert('Succcessful Login');window.location.href='admin_dashboard.php';</script>";
}
else
{
  echo "<script>alert('failed Login');window.location.href='admin_login.php';</script>";
}
}
?>
<html>
        ...
        <div class="col-md-6">
            <div class="card">
                <form class="box" action="" method="post" enctype="multipart/form-data">
                   <i class="fa fa-user-secret"style="font-size: 50px;color: white"></i><h1>Admin Login</h1>
