...
$sql="SELECT * FROM `patient registration`where `User name`='$Username' and `Password`='$Password'";
//echo $sql;
...
{
  echo "<script>alert('Succcessful Login');</script>";
}
}
?>
<html>
        ...
        <div class="col-md-6">
            <div class="card">
                <form class="box" action="" method="post" enctype="multipart/form-data">
                   <i class="fa fa-user"style="font-size: 50px;color: white"></i><h1>Patient Login</h1>
