...
-->
  ...
  <div class="col-sm-1" ><a href="doctor_dashboard.php"><img src="images/logo.png";style="border-radius:100%"width="100px";height="100px"/></a></div>
  <div class="col-sm-10" >
  <!--nav bar coding -->
  ...
  <div class="collapse navbar-collapse pl-3" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ml-3 px-2">
      <li class="nav-item active">
        <a style="font-size: 22px;" class="nav-link " href="doctor_dashboard.php"><i class="fa fa-dashboard" >
    </i>&nbsp;Dashboard</a>
      </li>
      <li class="nav-item">
        <a style="font-size: 22px;"  class="nav-link" href="DMyDetail.php"><i class="fa fa-file" ></i>&nbsp;My Details</a>
      </li>
      <li class="nav-item">
        <a style="font-size: 22px;" class="nav-link" href="MyAppointment.php"><i class="fa fa-upload" ></i>&nbsp;My Appointment</a>
      </li>
       <li class="nav-item">
        <a style="font-size: 22px;"  class="nav-link" href="ViewCustomer.php"><i class="fa fa-upload" >
    </i>&nbsp;Search Patient</a>
      </li>
       <li class="nav-item">
        <a style="font-size: 22px;"  class="nav-link" href="AddDescription.php"><i class="fa fa-upload" >
    </i>&nbsp;Add Description</a>
      <li class="nav-item">
        <a style="font-size: 22px;"  class="nav-link " href="doctor_logout.php"><i class="fa fa-sign-out" >
    </i>&nbsp;Logout</a>
      </li>
    </ul>
  </div></div>
