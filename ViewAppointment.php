...
<!--background image-->
<h1 style="text-align: center;font-size:50px;font-family:'monotype corsiva';">ViewAppointment</h1>
<table class="table mt-5">
  <thead class="table-dark">
    <tr>
    	<td>Appointment Ids</td>
    	<td>Booking Id</td>
      <td>Patient Name</td>
    	<td>Type</td>
    	<td>Doctor Name</td>
...
$sql="select bookappointment.*,doctor.* from bookappointment,doctor where bookappointment.categorie=doctor.specialisation order by bookappointment.aapId asc";
//echo $sql;
